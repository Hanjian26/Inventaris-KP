...
use App\Http\Controllers\Admin\PeminjamUserController;
...
Route::group(['middleware' => 'userlogin'], function () {
    ...
    Route::middleware(['checkRoleUser:/barang,submenu'])->group(function () {
        ...
        Route::get('/admin/barang/printqrcode/{index}', [BarangController::class, 'printqrcode']);
    ...
    Route::middleware(['checkRoleUser:/scanqr,menu'])->group(function () {
        // QR CODE
        Route::resource('/admin/scanqr', \App\Http\Controllers\Admin\ScanQRController::class);
        Route::get('/admin/scanqr/getbarang/{kode}', [ScanQRController::class, 'getbarang']);
    });
    ...
    Route::middleware(['checkRoleUser:/peminjaman,menu'])->group(function () {
        // Peminjaman

        // ADMIN
        Route::resource('/admin/peminjaman', \App\Http\Controllers\Admin\PeminjamAdminController::class);
        Route::get('/admin/peminjamanadmin/show/', [PeminjamAdminController::class, 'show'])->name('pinjamadmin.getdata');
        Route::post('/admin/peminjamanadmin/proses_konfirmasi/{peminjaman}', [PeminjamAdminController::class, 'proses_konfirmasi']);
        Route::post('/admin/peminjamanadmin/proses_pengembalian/{peminjaman}', [PeminjamAdminController::class, 'proses_pengembalian']);

        // USER
        Route::resource('/admin/peminjamanuser/showuser/', \App\Http\Controllers\Admin\PeminjamUserController::class);
        Route::get('/admin/peminjamanuser/show/', [PeminjamUserController::class, 'show'])->name('pinjamuser.getdata');
        Route::post('/admin/peminjamanuser/proses_tambah/', [PeminjamUserController::class, 'proses_tambah'])->name('pinjamuser.store');
        Route::post('/admin/peminjamanuser/proses_ubah/{peminjaman}', [PeminjamUserController::class, 'proses_ubah']);
        Route::post('/admin/peminjamanuser/proses_hapus/{peminjaman}', [PeminjamUserController::class, 'proses_hapus']);
    });
