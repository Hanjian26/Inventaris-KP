        ...
        <div class="card bg-success img-card box-success-shadow">
            <div class="card-body">
                <div class="d-flex">
                    ...
                    <div class="ms-auto"> <i class="fe fe-map-pin text-white fs-40 me-2 mt-2"></i> </div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">
        <div class="card bg-primary img-card box-primary-shadow">
            <div class="card-body">
                <div class="d-flex">
                    <div class="text-white">
                        <h2 class="mb-0 number-font">{{$peminjam}}</h2>
                        <p class="text-white mb-0">Peminjaman</p>
                    </div>
                    <div class="ms-auto"> <i class="fe fe-clipboard text-white fs-40 me-2 mt-2"></i> </div>
                </div>
            </div>
        </div>
    </div>
